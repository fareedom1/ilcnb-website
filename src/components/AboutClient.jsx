...
export default function AboutClient({ initialBgImage }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full space-y-24">
      ...
      {/* Mission Section */}
      <section className="flex flex-col md:flex-row gap-12 items-center cursor-default">
        <div className="md:w-1/2 space-y-6">
          <h2 className="text-3xl md:text-4xl font-extrabold text-stone-900">Our Story & Mission</h2>
          <div className="space-y-4 text-stone-600 text-lg leading-relaxed">
            <p>Established in 2020, the Islamic Learning Center of North Broward (ILCNB) was founded to provide a welcoming space for our local Muslim community to worship, learn, and grow together in accordance with the Quran and the Sunnah of Prophet Muhammad (PBUH).</p>
            <p>Over the years, our ummah has rapidly grown across four major cities—Parkland, Coconut Creek, Deerfield Beach, and Boca Raton—areas previously without a close place of worship.</p>
            <p>Alhamdulillah, our congregation has grown so rapidly that we consistently reach maximum capacity during our weekly Jummah prayers and Ramadan Iftars. As we look to the future, we are actively pursuing plans to expand our facilities to accommodate our thriving community and serve it as a place of worship and learning.</p>
          </div>
        </div>
        <div className="md:w-1/2 w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl relative group bg-stone-100">
          {initialBgImage && (
            <img 
              src={initialBgImage} 
            ...
            >
              ...
              {leader.phone && (
                <a 
                  ...
                  className="mt-3 text-stone-500 hover:text-emerald-600 transition-colors text-sm font-medium cursor-pointer"
                >
                  {leader.phone}
                </a>
              )}
      ...
      <section className="bg-stone-900 rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row shadow-2xl cursor-default">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-stone-300 leading-relaxed cursor-text">4405 W Hillsboro Blvd<br />Coconut Creek, FL 33073</p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="mailto:contact@ilcnb.org" className="text-stone-300 hover:text-emerald-400 transition-colors cursor-pointer">contact@ilcnb.org</a>
              </div>
            </div>
          </div>
        </div>
