...
export default function EventsClient({ initialBgImage }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 cursor-default">
      ...
      <div className="mt-24 mb-8 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        <div className="w-full md:w-1/2">
          <div className="relative rounded-[2.5rem] overflow-hidden shadow-xl aspect-[4/3] group bg-stone-100">
            {initialBgImage && (
              <img 
                src={initialBgImage} 
        ...
        <div className="w-full md:w-1/2 space-y-6 text-center md:text-left cursor-default">
          ...
          <p className="text-stone-600 text-lg leading-relaxed">
            Our facilities are available for community gatherings, educational halaqas, and special occasions. We would love to help you plan and host your next event. Contact us at <strong className="cursor-text">contact@ilcnb.org</strong>.
          </p>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
            <a 
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3.5 px-8 rounded-full transition-all duration-300 w-full sm:w-auto flex items-center justify-center gap-3 shadow-lg hover:shadow-emerald-600/30 hover:-translate-y-1 cursor-pointer"
            >
              <Send size={18} />
              Email Us
            </a>
